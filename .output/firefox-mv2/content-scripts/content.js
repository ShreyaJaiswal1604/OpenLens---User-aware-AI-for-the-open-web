...
`)}const D={matches:["<all_urls>"],runAt:"document_idle",main(){if(window.location.protocol==="chrome-extension:"||window.location.protocol==="moz-extension:")return;const e=document.createElement("div");e.id="openlens-bar",e.style.cssText='all: initial; position: fixed; top: 0; left: 0; width: 100%; z-index: 2147483647; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, monospace;',document.body.appendChild(e);const r=e.attachShadow({mode:"closed"}),t=document.createElement("style");t.textContent=`
    ...
    `,r.appendChild(t);const l=document.createElement("div");r.appendChild(l);const d=document.createElement("div");r.appendChild(d);let p=null,u="none",m=0,b=!1,v=[],y={totalTokens:0,contextUsed:0,contextLimit:8192,processingLocation:"idle",mcpToolCount:0,dataEntries:[],auditEvents:[]};function f(n,a,s){return new Promise(o=>{const i={page_read:"Read This Page",page_action:"Interact With Page",data_send:"Send Data to Cloud"}[n]||n;d.innerHTML=`
